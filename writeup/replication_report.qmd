...
-   [Preregistration](https://hyunwoogu.github.io/exp/visual_search) (For online demo. Main experiment will be done in-lab.)
...
data_searcher = read.csv('/Users/hyunwoogu/Dropbox/courses/Graduate/2022/2022Autumn/PSYCH251/assignments/najemnik2005/writeup/data/pilot_a/searcher_behavior.csv') 
data_human    = read.csv('/Users/hyunwoogu/Dropbox/human_behavior005.csv')    # human searcher (n=1)
data_eye      = read.csv('/Users/hyunwoogu/Dropbox/eye_track005.csv')         # human eye fixation time-series data
...
for (i_trial in 1:nrow(data_human)){
  # number of fixations = fixation onsets between stimulus onset & target detection - 1 (initial fixation)
  n_fix[i_trial] = sum(
