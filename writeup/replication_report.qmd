...
-   [Experimental paradigm](https://hyunwoogu.github.io/exp/visual_search) (Demo-only. Under construction.)
...
Data preparation will be done using `Python`, and will be shared via GitHub.
...
The analyses will be performed in the following steps: 

+ **Searcher model simulation**

+ **Nested linear model comparison**

Side-by-side comparison with the original figure (Figure 4a) will be provided:
